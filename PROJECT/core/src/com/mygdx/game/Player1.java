...
public class Player1 extends Characters {
    ...
    public void generatePlayerAnimation()
    {
        ...
        Texture hitted = assetManager.get("Sprite1/Take Hit.png");
        Texture fall = assetManager.get("Sprite1/Fall.png");

        //membuat animasi diam hadap kanan
        TextureRegion[] frames = MyGdxGame.CreateAnimationFrames(idle, idle.getWidth()/10, idle.getHeight(), 10, false, false);
        idleRightAnimation = new Animation<TextureRegion>(0.09f, frames);

        //membuat animasi diam hadap kiri, sumbu x di-flip
        frames = MyGdxGame.CreateAnimationFrames(idle, idle.getWidth()/10, idle.getHeight(), 10, true, false);
        idleLeftAnimation = new Animation<TextureRegion>(0.09f, frames);

        //membuat animasi jalan hadap kanan
        frames = MyGdxGame.CreateAnimationFrames(run, run.getWidth()/10, run.getHeight(), 10, false, false);
        runRightAnimation = new Animation<TextureRegion>(0.09f, frames);

        //membuat animasi jalan hadap kiri, sumbu x di-flip
        frames = MyGdxGame.CreateAnimationFrames(run, run.getWidth()/10, run.getHeight(), 10, true, false);
        runLeftAnimation = new Animation<TextureRegion>(0.09f, frames);

        //animasi loncat ke kanan
        frames = MyGdxGame.CreateAnimationFrames(jump, jump.getWidth()/3, jump.getHeight(), 3, false, false);
        runRightJump = new Animation<TextureRegion>(0.09f, frames);

        //animasi loncat ke kiri
        frames = MyGdxGame.CreateAnimationFrames(jump, jump.getWidth()/3, jump.getHeight(), 3, true, false);
        ...
        //mati hadap kanan
        frames = MyGdxGame.CreateAnimationFrames(death, death.getWidth()/10, death.getHeight(), 10, false, false);
        runRightDeath = new Animation<TextureRegion>(0.09f, frames);

        //mati hadap kiri
        frames = MyGdxGame.CreateAnimationFrames(death, death.getWidth()/10, death.getHeight(), 10, true, false);
        runLeftDeath = new Animation<TextureRegion>(0.09f, frames);

        //kena hit dari kanan
        frames = MyGdxGame.CreateAnimationFrames(hitted, hitted.getWidth()/1, hitted.getHeight(), 1, false, false);
        runRightHitted = new Animation<TextureRegion>(0.06f, frames);

        //kena hit dari kiri
        frames = MyGdxGame.CreateAnimationFrames(hitted, hitted.getWidth()/1, hitted.getHeight(), 1, true, false);
        runLeftHitted= new Animation<TextureRegion>(0.06f, frames);

        frames = MyGdxGame.CreateAnimationFrames(fall, fall.getWidth()/3, fall.getHeight(), 3, false, false);
        runRightFall = new Animation<TextureRegion>(0.09f, frames);

        frames = MyGdxGame.CreateAnimationFrames(fall, fall.getWidth()/3, fall.getHeight(), 3, true, false);
    ...
    public boolean canHit (Characters p2) {
        if (getHP() > 0) {
